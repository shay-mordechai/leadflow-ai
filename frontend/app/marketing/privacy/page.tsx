...
// 1. Add SEO Metadata (Only works in Server Components)
export const metadata: Metadata = {
    title: "Privacy Policy - LeadFlow AI",
    description: "Read about how we handle your data, call recordings, and privacy.",
};

// 2. This is a Server Component by default (No 'use client' needed)
